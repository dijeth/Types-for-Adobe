...
declare class ProjectItem {
	 ...
	 * 
	 */
	readonly getAudioChannelMapping: AudioChannelMapping;
	 ...
	 * 
	 */
	setAudioChannelMapping(sourceChannelMapping: AudioChannelMapping): boolean;
...
declare class Encoder {
	 ...
	 * 
	 */
	encodeFile(inputFilePath: string, outputFilePath: string, presetPath: string, removeOnCompletion?: number, startTime?: object, stopTime?: object, startQueueImmediately?: number): string;

	/**
	 * 
	 */
	encodeProjectItem(projectItem: ProjectItem, outputFilePath: string, presetPath: string, WorkAreaType?: number, removeOnCompletion?: number, startQueueImmediately?: number): string;

	/**
	 * 
	 */
	encodeSequence(sequence: Sequence, outputFilePath: string, presetPath: string, WorkAreaType?: number, removeOnCompletion?: number, startQueueImmediately?: number): string;
